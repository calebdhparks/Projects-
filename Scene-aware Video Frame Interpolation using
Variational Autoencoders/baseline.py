...
class YourName(torch.utils.data.Dataset):
    def __init__(self, 
                 resolution = 142, 
                 #root_dir="/home/ubuntu/DATA/png/p142/data",
		 root_dir="./mys3bucket/sample/png/p142/data", 
                 transform=None,
                 train = True):
        """
        Args:
    ...
    def identify_unique_images(self):
        #df = pd.read_csv("/home/ubuntu/VAE/unique-images.csv")
         df = pd.read_csv("/home/caleb/intro_to_DL/superFrameRate/unique-images.csv")
